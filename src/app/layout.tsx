  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="clinica-mandalay-logopedia-y";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Clínica Mandalay | Logopedia y salud"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="clinica-mandalay-logopedia-y"
          data-primary-color="#c7b8af"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="clinica-mandalay-logopedia-y";
